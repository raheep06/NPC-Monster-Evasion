...
difficultySelectorGui.Name = "difficulty50SelectorGui"
...
--[[ Creation of a difficulty button for the specific 50 second time, so that the player 
...
local winLossConditionGUI = game.Players.LocalPlayer.PlayerGui:WaitForChild("winLoss50ConditionGui")
local getReadyGUI = game.Players.LocalPlayer.PlayerGui:WaitForChild("getReadyGui")

local function beginEvent (difficulty)
	local replicatedStorage = game:GetService("ReplicatedStorage")
	local timeSetEvent = replicatedStorage.TimeSet50Event
