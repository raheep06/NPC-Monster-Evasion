...
difficultySelectorGui.Name = "difficulty25SelectorGui"
...
--[[ Creation of a difficulty button for the specific 25 second time, so that the player 
...
local winLossConditionGUI = game.Players.LocalPlayer.PlayerGui:WaitForChild("winLoss25ConditionGui")
local getReadyGUI = game.Players.LocalPlayer.PlayerGui:WaitForChild("getReadyGui")

local function beginEvent (difficulty)
	local replicatedStorage = game:GetService("ReplicatedStorage")
	local timeSetEvent = replicatedStorage.TimeSet25Event
