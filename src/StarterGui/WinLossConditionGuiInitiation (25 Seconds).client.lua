...
winLossConditionGUI.Name = "winLoss25ConditionGui"
...
winTextLable.Text = "Winning Condition: Do not die for a minimum of 25 seconds"
...
lossTextLable.Text = "Losing Condition: Die within 25 seconds"
