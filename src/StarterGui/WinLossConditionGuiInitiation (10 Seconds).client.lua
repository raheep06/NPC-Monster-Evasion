...
winLossConditionGUI.Name = "winLoss10ConditionGui"
...
winTextLable.Text = "Winning Condition: Do not die for a minimum of 10 seconds"
...
lossTextLable.Text = "Losing Condition: Die within 10 seconds"
